 ...
 *
 * Each guide is structured so it can render as a semantic <article> and emit
 * Article / MedicalWebPage structured data. Body blocks support headings,
 * paragraphs, and bullet lists.
 *
 * Editorial note: starter copy below is drafted for review. Have a clinician on
 * the medical review board verify each guide before publication, then update the
 * `reviewedBy` and `updated` fields.
 *
